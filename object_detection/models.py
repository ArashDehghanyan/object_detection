...
from tensorflow.keras.layers import Input, Reshape, Activation, Conv2D, MaxPooling2D, BatchNormalization, LeakyReLU, Dense, Lambda, Flatten, concatenate
...
class CustomLearningRateScheduler(keras.callbacks.Callback):
    ...
    def on_epoch_begin(self, epoch, logs=None):
        ...
        # Call schedule to achieve scheduled learning rate
